...
dir_in = '/data_CMS_upgrade/mperez/HGCal_data/thesis/algoB/calibrated/'
...
dir_out = '/data_CMS_upgrade/mperez/HGCal_data/thesis/algoB/pubdt/'
...
dir_out_model = '/data_CMS_upgrade/mperez/HGCal_data/thesis/algoB/models/pubdt/'
...
plotdir = '/data_CMS_upgrade/mperez/HGCal_data/thesis/algoB/plots/pubdt/'
...
for name in df_tau:
  print df_nu[name]['cl3d_pt_c3']
  print df_tau[name]['cl3d_pt_c3']
...
#myvariable = 'cl3d_ntc67'
#myvariable = 'cl3d_srrtot'
myvariable = 'cl3d_coreshowerlength'

for name in df_tau:

  plt.figure(figsize=(8,8))
  plt.hist(df_nu_train[name][myvariable],    bins=np.arange(0., 35., 1.),  label='Background',      color='red',    histtype='step', lw=2, normed=True)
  plt.hist(df_tau_train[name][myvariable],   bins=np.arange(0., 35., 1.),  label='Signal',   color='blue',    histtype='step', lw=2, normed=True)
  red_line = mlines.Line2D([], [], color='red',markersize=15, label='Background',lw=2)
  blue_line = mlines.Line2D([], [], color='blue',markersize=15, label='Signal',lw=2)
  #plt.legend(loc = 'lower right',handles=[red_line,blue_line])
  plt.legend(loc = 'upper left',handles=[red_line,blue_line])
  plt.grid()
  plt.xlabel(r'Core shower length')
  #plt.xlabel(r'Number of TCs with 67% of energy')
  ...
  plt.savefig(plotdir+'calib_'+myvariable+'_TDRv2.png')
  plt.savefig(plotdir+'calib_'+myvariable+'_TDRv2.pdf')
  plt.show()
...
plt.cmstext("CMS"," Phase-2 Simulation")
plt.lumitext("PU=200"," ")
plt.savefig(plotdir+'pubdt_roc_nclusters_TDRv1.png')
plt.savefig(plotdir+'pubdt_roc_nclusters_TDRv1.pdf')
'''
