...
axs[0].set_ylabel(r'$RMS_{eff}(E_{T}^{L1}/p_{T}^{gen})$')
axs[1].set_xlim(20., 100.)
axs[1].set_ylim(0.95,1.40)
axs[1].set_xlabel(r'$p_{T}\, [GeV]$')
axs[1].set_ylabel('Ratio to Threshold')
axs[1].grid()
plt.savefig(plotdir+'calib_effrms_vs_pt_ratio_TDRv1.png')
plt.savefig(plotdir+'calib_effrms_vs_pt_ratio_TDRv1.pdf')
...
for name in df_tau:
  ...
  df = ptmeans[name]
  axs[0].plot(df['gentau_vis_pt'], df['cl3d_response_c3'],color=colors[name], label=legends[name],lw=2)
  ratio = ptmeans[name]['cl3d_response_c3']/ptmeans[0]['cl3d_response_c3']
  axs[1].plot(df['gentau_vis_pt'], ratio, color=colors[name], label=legends[name],lw=2)
...
axs[0].grid()
#axs[0].set_xlabel(r'$RMS(p_{T}^{L1}/p_{T}^{gen})$')
axs[0].set_ylabel(r'$\langle E_{T}^{L1}/p_{T}^{gen} \rangle$')
axs[1].set_xlim(20., 100.)
axs[1].set_ylim(0.95,1.05)
axs[1].set_xlabel(r'$p_{T}\, [GeV]$')
axs[1].set_ylabel('Ratio to Threshold')
axs[1].grid()
plt.savefig(plotdir+'calib_options_pt2.png')
plt.savefig(plotdir+'calib_options_pt2.pdf')
...
for name in df_tau:
  ...
  df = etameans[name]
  axs[0].plot(df['gentau_vis_abseta'], etameans[name]['cl3d_response_c3'],color=colors[name], label=legends[name],lw=2)
  ratio = etameans[name]['cl3d_response_c3']/etameans[0]['cl3d_response_c3']
  axs[1].plot(df['gentau_vis_abseta'], ratio, color=colors[name], label=legends[name],lw=2)
...
axs[1].set_ylabel('Ratio to Threshold')
axs[1].grid()
plt.savefig(plotdir+'calib_options_eta2.png')
plt.savefig(plotdir+'calib_options_eta2.pdf')
'''
