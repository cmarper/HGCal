...
dir_out = '/data_CMS_upgrade/mperez/HGCal_data/FE_options_Nov19/algoA/pubdt/'

file_out_tau = {}

file_out_tau[0] = dir_out+'ntuple_TauGun_THRESHOLD_pubdt_algoA.hdf5'
file_out_tau[1] = dir_out+'ntuple_TauGun_SUPERTRIGGERCELL_pubdt_algoA.hdf5'
file_out_tau[2] = dir_out+'ntuple_TauGun_BESTCHOICE_pubdt_algoA.hdf5'
file_out_tau[3] = dir_out+'ntuple_TauGun_BESTCHOICECOARSE_pubdt_algoA.hdf5'
file_out_tau[4] = dir_out+'ntuple_TauGun_MIXEDBCSTC_pubdt_algoA.hdf5'

file_out_nu = {}

file_out_nu[0] = dir_out+'ntuple_NuGun_THRESHOLD_pubdt_algoA.hdf5'
file_out_nu[1] = dir_out+'ntuple_NuGun_SUPERTRIGGERCELL_pubdt_algoA.hdf5'
file_out_nu[2] = dir_out+'ntuple_NuGun_BESTCHOICE_pubdt_algoA.hdf5'
file_out_nu[3] = dir_out+'ntuple_NuGun_BESTCHOICECOARSE_pubdt_algoA.hdf5'
file_out_nu[4] = dir_out+'ntuple_NuGun_MIXEDBCSTC_pubdt_algoA.hdf5'

###########

dir_out_model = '/data_CMS_upgrade/mperez/HGCal_data/FE_options_Nov19/algoA/models/pubdt/'

file_out_model = {}

file_out_model[0] = dir_out_model+'model_pubdt_algoA_threshold.pkl'
file_out_model[1] = dir_out_model+'model_pubdt_algoA_supertriggercell.pkl'
file_out_model[2] = dir_out_model+'model_pubdt_algoA_bestchoice.pkl'
file_out_model[3] = dir_out_model+'model_pubdt_algoA_bestchoicecoarse.pkl'
file_out_model[4] = dir_out_model+'model_pubdt_algoA_mixedbcstc.pkl'

###########

plotdir = '/data_CMS_upgrade/mperez/HGCal_data/FE_options_Nov19/algoA/plots/pubdt/'
...
for name in file_in_nu:
  ...
  print 'in: ',np.unique(df_nu[name].reset_index()['event']).shape[0]
  store_nu.close()
...
for name in df_tau:
  ...
  sel = df_nu_train[name]['cl3d_pt'] > 20
...
for name in df_nu:
  ...
  print 'out: ',np.unique(df_nu[name].reset_index()['event']).shape[0]
  store_nu.close()
...
plt.savefig(plotdir+'pubdt_roc_nclusters.png')
