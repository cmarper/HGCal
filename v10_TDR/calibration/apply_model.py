...
file = uproot.open('/data_CMS/cms/mperez/HGCal_data/Aug19/ntuple_RelValDiTau_Pt20To100_Etam1p6Tom2p9_clustered_flat.root')
file.keys()
tree = file["FlatTree"]
tree.keys
...
f_in = TFile("/data_CMS/cms/mperez/HGCal_data/Aug19/ntuple_RelValDiTau_Pt20To100_Etam1p6Tom2p9_clustered_flat.root", 'read')
t_in = f_in.Get("FlatTree")

f_out = TFile("/data_CMS/cms/mperez/HGCal_data/Aug19/ntuple_RelValDiTau_Pt20To100_Etam1p6Tom2p9_clustered_flat_calibs.root", 'recreate')
